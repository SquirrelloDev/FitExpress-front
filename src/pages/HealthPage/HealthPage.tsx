...
function HealthPage() {
	...
	const {data: progressData, isLoading: isProgressLoading, isError:isProgressError, isSuccess: isProgressSuccess} = useUserProgressQuery({id: userData.id, token: userData.token})
	return (
