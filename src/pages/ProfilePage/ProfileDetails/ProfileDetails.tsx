            ...
            {!isLoading && (
                <div className={classes.details__wrapper}>
                    <div className={classes.details__grid}>
                        <UserEditForm token={userData.token} id={userData.id} name={data!.user.name}
                    ...
                    <div className={classes.details__delete}>
                        ...
                        <p>Otrzymasz zwrot pieniędzy na konto bankowe w ciągu 3 dni od skasowania konta w przypadku
                            istniejącej aktywnej diety.</p>
                        <button onClick={open} className={clsx(btnStyles.btn, btnStyles['btn--danger'])}>Usuń konto
                        </button>
                    </div>
                    </div>
                    {opened &&
