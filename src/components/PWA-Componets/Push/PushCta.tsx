...
function PushCta() {
	...
	return (
			<button disabled={(isCreating || isRemoving)} className={clsx(btnStyles.btn, btnStyles['btn--dark'], classes.profile__nav__item, classes['profile__nav__item--notification'])}
